...
class MusiciansControllerTest < ActionController::TestCase
  ...
  test "should create musician" do
    assert_difference('Musician.count') do
      post :create, musician: { about: @musician.about, genre: @musician.genre, instrument: @musician.instrument, name: @musician.name }
    end
  ...
  test "should update musician" do
    patch :update, id: @musician, musician: { about: @musician.about, genre: @musician.genre, instrument: @musician.instrument, name: @musician.name }
    assert_redirected_to musician_path(assigns(:musician))
  end
