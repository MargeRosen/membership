...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { about: @band.about, bandname: @band.bandname, genre: @band.genre, musicians: @band.musicians, wanted: @band.wanted }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { about: @band.about, bandname: @band.bandname, genre: @band.genre, musicians: @band.musicians, wanted: @band.wanted }
    assert_redirected_to band_path(assigns(:band))
  end
